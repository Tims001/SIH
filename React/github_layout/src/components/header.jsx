        ...
        <header className="w-[calc(100%-280px)] h-[70px] bg-white fixed right-0 top-0 pl-5 flex items-center transition-all duration-700" ref={head}>
            ...
            <form className="w-[50%]">
                ...
                <div className="relative overflow-hidden">
                    ...
                    <input type="text" id="search" className="block w-full h-full p-4 ps-10 text-lg text-gray-900  rounded-md bg-white border-2 border-gray-500 focus:outline-none  focus:border-blue-800 focus:shadow-lg overflow-hidden transition-all duration-700" placeholder="Search here" required ref={formInput} />
